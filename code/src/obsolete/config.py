...
class Config:
    ...
    if COLLECTOR_CONFIG_FILE is not None and os.path.isfile(COLLECTOR_CONFIG_FILE):
                ...
                SQLALCHEMY_COMMIT_ON_TEARDOWN  = config_init.getboolean('General','SQLALCHEMY_COMMIT_ON_TEARDOWN',fallback=True)
                SQLALCHEMY_TRACK_MODIFICATIONS = config_init.getboolean('General','SQLALCHEMY_TRACK_MODIFICATIONS',fallback=False)
                MAIL_SERVER                    = config_init.get       ('General','MAIL_SERVER')
                ......
                AQUI ME QUEDE ....
                .......        
