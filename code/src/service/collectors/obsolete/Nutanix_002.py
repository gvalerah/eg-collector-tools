...
def Nutanix_002_Collector(C,ini_file):
    ...
    if (os.path.isfile(ini_file)):    
        ...
        if active:
            ...
            file            =   config.get('General','json_file_name',fallback=None)
            ...
            if N.ETL_load_json()==0:
                ...
                C.logger.error("%s: loading %s file"%(__name__,N.json_file_name) )           
        else:
