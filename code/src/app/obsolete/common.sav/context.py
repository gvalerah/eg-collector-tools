...
class Context:
    ...
    def Read_Configuration(self,app_ini_file):
        ...
        self.service_folder = self.config['General']['service_folder']
        self.plugins_folder = self.config['General']['plugins_folder']
        self.collectors_folder = self.config['General']['collectors_folder']
