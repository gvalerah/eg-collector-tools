...
def pi_1000013_0(data):
    print("%s: ***************"%__name__)
    print("%s: pi_1000013 0 IN"%__name__)
    print("%s: ***************"%__name__)
...
def pi_1000013_1(data):
    print("%s: ***************"%__name__)
    print("%s: pi_1000013 1 IN"%__name__)
    print("%s: ***************"%__name__)
    data[0]['redirect']='/plugins'
    return data
    
class frm_pi_1000013(Form):
    ...
    functions   = []
    functions.append(pi_1000013_0)
    functions.append(pi_1000013_1)
    
    
def pi_1000013(data):
    data.append({'code':1000013,'description':'Mi descripcion','form':frm_pi_1000013()})
    print("data=",data)
    return data
