...
def add_Logging_Levels():            
        ...
        if hasattr(logging,'TRACE'):
            print(" * %s: add_Logging_Levels: Special logging level TRACE added ..."%__name__)        
        else:
            print(" * %s: add_Logging_Levels: Special logging level TRACE failed to be added ..."%__name__)
        if hasattr(logging,'DEBUG'):
            print(" * %s: add_Logging_Levels: Special logging level DEBUG added ..."%__name__)        
        else:
            print(" * %s: add_Logging_Levels: Special logging level DEBUG failed to be added ..."%__name__)
