...
def Gen_Templates_Delete(Metadata,Tab,Chd,app_folder):
    ...
    file_name = auto_templates+"/"+table_name.lower()+"_delete.html"
    ...
    if Tab['has_child']:
        ...
        f.write('           <td>'\
                                ...
                                %(Chd['table'],link_keys,Chd['table'],link_keys) )      
        f.write(    '       </tr>\n')
        f.write(    '    {% endfor %}\n')    
        f.write(    '  </tbody>\n')
        f.write(    '</table>\n')    
